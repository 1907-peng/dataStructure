...
<%
    ...
    String partStuName = request.getParameter("partStuName");
    String sql = null;
    if (id != null) {
        sql = "select * from score where id='" + id + "'";
    } else if (stuName != null) {
        sql = "select * from score where name='" + stuName + "'";
    } else if (partStuName != null) {
        sql = "select * from score where name like'" + "%" + partStuName + "%" + "'";
    }
...
%>
<center><a href="teacher_menu.jsp" class="btn btn-info" role="button">返回主页</a></center>
<%
} else {
%>
...
<form name="form1" method="post">
    <table class="table table-condensed table-hover">
        ...
        <tr>
            ...
            <a href="teacher_menu.jsp" class="btn btn-info" role="button">返回</a>
        </tr>
    </table>
</form>
<%
