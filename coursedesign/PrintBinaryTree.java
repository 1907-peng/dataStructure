...
class PrintBinaryTree {
    public static void print() {
        ...
        // 得到树的深度
        int treeDepth = getTreeDepth(BinaryTree.root);
        ...
        writeArray(BinaryTree.root, 0, arrayWidth / 2, res, treeDepth);
    ...
    private static void writeArray(BinaryTreeNode currNode, int rowIndex, int columnIndex, String[][] res, int treeDepth) {
        ...
        // 先将当前节点保存到二维数组中
        res[rowIndex][columnIndex] = String.valueOf(currNode.e.jobNumber);
