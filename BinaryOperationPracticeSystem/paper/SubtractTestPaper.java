...
public class SubtractTestPaper extends AbstractTestPaper {
    private int score;
    ...
    public SubtractTestPaper(int formulasQuantity) throws IOException {
        int option = 0;
    ...
    private void getExerciseOfBaseFormula(int formulasQuantity) {
        isInputLegal = true;
        try (ObjectInputStream objectInputStream = new ObjectInputStream(new FileInputStream("C:/JavaFile/SubtractBase.txt"))) {
    ...
    private void getExerciseOfRandomFormula(int formulasQuantity) {
        isInputLegal = true;
        for (int i = 0; i < formulasQuantity; i++) this.formulasList.add(new SubtractOperation());
    }
